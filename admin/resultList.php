...
<div class="container mt-5">
  ...
  <thead>
   ...
   <div>
    ...
    <button type="button" class="btn btn-outline-danger">Add Result</button>
        </a>
  ...
  <?php foreach ($resultInfos as $resultInfo){ ?>
    <tr>
        ...
        <td><?= $resultInfo['10']?></td>
          ...
          <td>
          <a href="resultEdit.php?result_id=<?= $resultInfo['0']?>" class="text-danger text-decoration-none"><i class="far fa-edit"></i>&nbsp;Edit</a> |
          <a href="resultDelete.php?id=<?= $resultInfo['0']?>" class="text-danger text-decoration-none" onclick="return confirm('Are you sure you want to delete this user?')"><i class="far fa-trash-alt delete" ></i>&nbsp;Delete</a>
          </td>
