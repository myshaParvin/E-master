      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            <img class="profile_img" src="https://source.unsplash.com/600x300/?student" alt="teacher dp">
            <h3>User ID : <?= $tInfo['8']?> </h3>
          </div>
          <div class="card-body text-center">
            <p class="mb-0"><strong class="pr-1">Name :</strong><?= " ".$tInfo['0']." ".$tInfo['1'] ?></p>
            <p class="mb-0"><strong class="pr-1">Email :</strong><?= " ".$tInfo['2'] ?></p>
