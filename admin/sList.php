    ...
    <tr>
        ...
        <td><?= $stdInfo['8']?></td>
          ...
          <td>
              ...
              <a href="sEdit.php?id=<?= $stdInfo['8']?>" class="text-danger"><i class="far fa-edit"></i>Edit</a> |
              <a href="sView.php?id=<?= $stdInfo['8']?>" class="text-danger"><i class="fas fa-eye"></i>Details</a> |
              <a href="sDelete.php?id=<?= $stdInfo['8']?>" class="text-danger" onclick="return confirm('Are you sure you want to delete this user?')"><i class="far fa-trash-alt delete" ></i>Delete</a>
          </td>
