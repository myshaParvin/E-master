...
<html lang="en">
  <head>
   ...
   <link href="../assets/css/Footerstyle.css" rel="stylesheet" type='text/css'>
    ...
    <title>E-Master | Fees Table</title>
  </head>
  <body>
...
<div class="container mt-5">
  ...
  <thead>
   <h1 class="text-center"><u>Student Fees Table</u></h1>
  ...
  <?php foreach ($fees as $fee){ ?>
    <tr>
        ...
        <td><?= $fee['7']?></td>
          ...
          <td>
              <a href="receipt.php?payment_id=<?= $fee['0']?>" class="text-danger text-decoration-none"> <i class="fas fa-file-alt"></i>&nbsp;Payments Report</a>
          </td>
